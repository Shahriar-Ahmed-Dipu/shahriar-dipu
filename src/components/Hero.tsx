  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 z-10 relative pt-20">
        <div className="max-w-4xl">
          <div className="space-y-1 overflow-hidden">
            <p className={cn(
              'text-primary font-medium tracking-wide slide-up',
            ...
            <p className={cn(
              'mt-6 text-lg text-muted-foreground max-w-2xl slide-up',
              isLoaded ? 'opacity-100' : 'opacity-0'
          ...
          <div className={cn(
            'mt-8 flex gap-4 items-center slide-up',
            isLoaded ? 'opacity-100' : 'opacity-0'
            ...
            <a 
              href="#about" 
              className="inline-flex items-center gap-2 font-medium text-muted-foreground hover:text-foreground transition-colors"
            >
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 pointer-events-none select-none">
        <div 
          className={cn(
            "absolute top-1/4 right-[10%] w-64 h-64 bg-primary/5 rounded-full blur-3xl transition-opacity duration-1000",
            isLoaded ? "opacity-100" : "opacity-0"
          )}
        />
        <div 
          className={cn(
            "absolute bottom-1/4 left-[10%] w-80 h-80 bg-blue-50 rounded-full blur-3xl transition-opacity duration-1000", 
            isLoaded ? "opacity-100" : "opacity-0"
          )}
